    ...
    <div className="lg:w-screen py-15 lg:mt-30 box-border opacity-100 font-sans md:py-30 lg:px-5 lg:p-0">
       ...
       <div className="w-full lg:mt-20 md:py-10 bg-blue-50 grid grid-cols-1 place-items-center md:grid-cols-2 lg:grid-cols-3 gap-2 lg:pb-30 h-fit">
        ...
        return (
            <div key={id} className="grid gap-8 md:m-3 m-5 w-fit lg:w-90 p-10 rounded-2xl bg-white">
                <div><FontAwesomeIcon icon={faStar} color="yellow"/><FontAwesomeIcon icon={faStar} color="yellow"/><FontAwesomeIcon icon={faStar} color="yellow"/><FontAwesomeIcon icon={faStar} color="yellow"/><FontAwesomeIcon icon={faStar} color="yellow"/></div>
      ...
      <div className="flex lg:flex-row flex-col p-5 lg:justify-center lg:items-center lg:gap-15 w-screen lg:mt-20">
        <div className="h-150 md:w-130 lg:h-100 lg:w-120 bg-blue-100 rounded-lg relative" onClick={()=>{ navigate('/videopage')}}> 
         <img src={videothumbnail} alt="" className="absolute lg:bottom-10 lg:right-10 lg:w-[75rem] h-auto rounded-2xl md:w-full "/>
