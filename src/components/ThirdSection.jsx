...
const ThirdSection = () => {
  ...
  return (
    <div className=" lg:p-20 p-5 md:p-10 flex flex-col lg:flex-row lg:items-center items-start justify-start gap-10 md:gap-20 bg-gray-50 opacity-90 box-border">
